        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-md-9 team">
                <div class="row category block-list international">
                    <div class="col-xs-6 col-sm-3 category-item">
                        <img src="<?=get_stylesheet_directory_uri()?>/images/contributors/Samantha-Culp2.jpg" width="135" height="135" alt="">
                        <h6 class="contributor-name">Samantha Culp</h6>
                    </div>
                    <div class="col-xs-6 col-sm-3 category-item">
                        <img src="<?=get_stylesheet_directory_uri()?>/images/contributors/Aurelien-Heilbronn.jpg" width="135" height="135" alt="">
                        <h6 class="contributor-name">Aurelien Heilbronn</h6>
                    </div>
                    <div class="col-xs-6 col-sm-3 category-item">
                        <img src="<?=get_stylesheet_directory_uri()?>/images/contributors/David-Mushegain.jpg" width="135" height="135" alt="">
                        <h6 class="contributor-name">David Mushegain</h6>
                    </div>
                    <div class="col-xs-6 col-sm-3 category-item">
                        <img src="<?=get_stylesheet_directory_uri()?>/images/contributors/Salvo-De-Malebranche1.jpg" width="135" height="135" alt="">
